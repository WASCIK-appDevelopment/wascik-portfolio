...
export default async function PublishedAffiliateProducts({ pagePath }: { pagePath: string }) {
  ...
  return <section className="relative z-10 px-5 py-16 text-white md:px-8">
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mt-9 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
        {products.map((product) => <article key={product.id} className="flex h-full flex-col overflow-hidden rounded-3xl border border-cyan-400/25 bg-gradient-to-br from-[#092238] to-[#020a12] shadow-[0_22px_60px_rgba(0,0,0,.3)]">
