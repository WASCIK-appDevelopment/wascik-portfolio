...
type Candidate = { id: string; merchant: string; title: string; reason: string; affiliateUrl: string; removable: boolean; source: "builtin" | "uploaded" };
