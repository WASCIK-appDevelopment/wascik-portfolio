...
type DraftResult = { primaryCopy?: string; headline?: string; cta?: string; salesLine?: string; visualHook?: string; visualSupportLine?: string; visualCta?: string; hashtags?: string[]; complianceNotes?: string[]; apiUsage?: { model?: string; inputTokens?: number; outputTokens?: number; estimatedCostUsd?: number | null } };
type Draft = {
...
export default function AdWorkspaceClient() {
  ...
  return <div style={{ display: "grid", gap: 16 }}>
    ...
    {result ? <>
      <PhotoAdComposer product={product} platform={platform} headline={result.headline || product.title} cta={result.cta || (firstParty ? "Learn more from WASCIK" : "Learn more through WASCIK Affiliate Services")} visualHook={result.visualHook} visualSupportLine={result.visualSupportLine} visualCta={result.visualCta} creativeNotes={creativeNotes} />
